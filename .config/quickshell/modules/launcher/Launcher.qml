        ...
        Rectangle {
            ...
            ListView {
              ...
              delegate: Rectangle {
                ...
                RowLayout {
                  ...
                  Text {
                    visible: del.modelData.kind === "calc" || del.modelData.kind === "bookmark" || del.modelData.kind === "web"
                    text: del.modelData.kind === "calc" ? "calc" : del.modelData.kind === "bookmark" ? (del.modelData.source || "mark") : "web"
                    color: Theme.fg
                    opacity: 0.4
                    font.family: Theme.monoFont
                    font.pixelSize: 9
          ...
          Connections {
            ...
            function onQueryChanged() {
              if (launcherRoot.query === "" && edit.text !== "") edit.text = ""
            }
          }
        }
      }
