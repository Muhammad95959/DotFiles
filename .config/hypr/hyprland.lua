...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("~/Scripts/daily_backup.sh")
...
hl.define_submap("shell", function()
  hl.bind("a", hl.dsp.exec_cmd(reset .. "quickshell ipc call appgrid toggle"))
  ...
  hl.bind("l", hl.dsp.exec_cmd(reset .. "quickshell ipc call liveWall toggle"))
  ...
  hl.bind("t", hl.dsp.exec_cmd(reset .. "quickshell ipc call todo toggle"))
  ...
  hl.bind("SHIFT + l", hl.dsp.exec_cmd(reset .. "quickshell ipc call liveWall toggleLive"))
