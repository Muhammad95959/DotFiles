...
hl.define_submap("apps", function()
  ...
  hl.bind("SHIFT + n", hl.dsp.exec_cmd(reset .. "quickshell ipc call wallpaper toggle"))
...
hl.define_submap("shell", function()
  ...
  hl.bind("l", hl.dsp.exec_cmd(reset .. "quickshell ipc call liveWall toggleLive"))
  ...
  hl.bind("SHIFT + l", hl.dsp.exec_cmd(reset .. "quickshell ipc call liveWall toggle"))
