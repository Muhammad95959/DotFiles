...
hl.window_rule({ match = { class = "^brave-__home_muhammad_Projects_new-tab-page_index.html-Default$" }, workspace = "special:bored silent" })
hl.window_rule({ match = { class = "^chrome-__home_muhammad_Projects_new-tab-page_index.html-Default$" }, workspace = "special:bored silent" })
...
hl.define_submap("applications", function()
  ...
  hl.bind("b", hl.dsp.exec_cmd(reset .. "/opt/brave.com/brave-origin-beta/brave-origin-beta --test-type --incognito"))
  ...
  hl.bind("p", hl.dsp.exec_cmd(reset .. "pomatez"))
  ...
  hl.bind("v", hl.dsp.exec_cmd(reset .. "virt-manager"))
  hl.bind("w", hl.dsp.exec_cmd(reset .. "/opt/brave.com/brave-origin-beta/brave-origin-beta --test-type --app-id=hnpfjngllnobngcgfapefoaidbinmjnm"))
...
hl.bind(mod .. " + b",              hl.dsp.exec_cmd("/opt/brave.com/brave-origin-beta/brave-origin-beta --test-type"))
